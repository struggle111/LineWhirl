 ...
 * 增加的功能：
 * 1、线条从右上角出发，过程分为4段：下降加速－>匀速->上升减速->匀速；
 * 2、增加差值器，控制线条的速度；
 */

public class WhirlSquareLineViewV3 extends View {
    private final static String TAG = WhirlSquareLineViewV3.class.getSimpleName();
    ...
    public WhirlSquareLineViewV3(Context context) {
        this(context, null);
    }

    public WhirlSquareLineViewV3(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WhirlSquareLineViewV3(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
